/*
 *  Author: Ford Hash
 *  Description: Final Project - Ocean rendering
...
public:
	...
	void draw() {
        ...
        glBegin(GL_QUADS);
        glTexCoord2f(0, 0);	    glVertex3f(0, height - heightOffset, 0);
        glTexCoord2f(1, 0);	    glVertex3f(width, height - heightOffset, 0);
        glTexCoord2f(1, 1);	    glVertex3f(width, height - heightOffset, length);
        glTexCoord2f(0, 1);	    glVertex3f(0, height - heightOffset, length);
        glEnd();

        glBindTexture(GL_TEXTURE_2D, front);
        glBegin(GL_QUADS);
        glTexCoord2f(0, 0);	    glVertex3f(0, -heightOffset, 0);
        glTexCoord2f(1, 0);	    glVertex3f(width, -heightOffset, 0);
        glTexCoord2f(1, 1);	    glVertex3f(width, height - heightOffset, 0);
        glTexCoord2f(0, 1);	    glVertex3f(0, height - heightOffset, 0);
        glEnd();

        glBindTexture(GL_TEXTURE_2D, back);
        glBegin(GL_QUADS);
        glTexCoord2f(0, 0);	    glVertex3f(width, -heightOffset, length);
        glTexCoord2f(1, 0);	    glVertex3f(0, -heightOffset, length);
        glTexCoord2f(1, 1);	    glVertex3f(0, height - heightOffset, length);
        glTexCoord2f(0, 1);	    glVertex3f(width, height - heightOffset, length);
        glEnd();

        glBindTexture(GL_TEXTURE_2D, left);
        glBegin(GL_QUADS);
        glTexCoord2f(0, 0);	    glVertex3f(0, -heightOffset, length);
        glTexCoord2f(1, 0);	    glVertex3f(0, -heightOffset, 0);
        glTexCoord2f(1, 1);	    glVertex3f(0, height - heightOffset, 0);
        glTexCoord2f(0, 1);	    glVertex3f(0, height - heightOffset, length);
        glEnd();

        glBindTexture(GL_TEXTURE_2D, right);
        glBegin(GL_QUADS);
        glTexCoord2f(0, 0);	    glVertex3f(width, -heightOffset, 0);
        glTexCoord2f(1, 0);	    glVertex3f(width, -heightOffset, length);
        glTexCoord2f(1, 1);	    glVertex3f(width, height - heightOffset, length);
        glTexCoord2f(0, 1);	    glVertex3f(width, height - heightOffset, 0);
        glEnd();
